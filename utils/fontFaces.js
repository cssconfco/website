...
const fontFaces = css.global`
  @font-face {
    font-family: 'Apercu Regular';
    font-style: normal;
    font-weight: normal;
    src: local('Apercu Regular'),
      url('/static/fonts/Apercu_Regular.woff') format('woff');
  }
  ...
  @font-face {
    ...
    font-style: normal;
    font-weight: normal;
    src: local('Apercu Light Italic'),
      url('/static/fonts/Apercu Light Italic.woff') format('woff');
  }
  ...
  @font-face {
    ...
    font-style: normal;
    font-weight: normal;
    src: local('Apercu Medium Italic'),
      url('/static/fonts/Apercu Medium Italic.woff') format('woff');
  }
  ...
  @font-face {
    ...
    font-style: normal;
    font-weight: normal;
    src: local('Apercu Bold Italic'),
      url('/static/fonts/Apercu Bold Italic.woff') format('woff');
  }
